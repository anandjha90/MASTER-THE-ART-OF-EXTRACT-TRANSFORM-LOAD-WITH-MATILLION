...
CREATE OR REPLACE DATABASE TEST_DST;
CREATE OR REPLACE SCHEMA TEST_SRC_SCHEMA;
...
(DEMO_DATABASE.DEMO_SCHEMA.AJ_TYPE
  ID INT	,
...
CREATE OR REPLACE TABLE CATEGORIES CLONE DEMO_DATABASE.DEMO_SCHEMA.AJ_CATAGORIES;
CREATE OR REPLACE TABLE COMPLAIN CLONE DEMO_DATABASE.DEMO_SCHEMA.AJ_COMPLAIN;
CREATE OR REPLACE TABLE CUSTOMER CLONE DEMO_DATABASE.DEMO_SCHEMA.AJ_CUSTOMER;
CREATE OR REPLACE TABLE PRIORITIES CLONE DEMO_DATABASE.DEMO_SCHEMA.AJ_PRIORITIES;
CREATE OR REPLACE TABLE PRODUCT CLONE DEMO_DATABASE.DEMO_SCHEMA.AJ_PRODUCT;
CREATE OR REPLACE TABLE REGION CLONE DEMO_DATABASE.DEMO_SCHEMA.AJ_REGION;
--CREATE OR REPLACE TABLE SALES CLONE DEMO_DATABASE.DEMO_SCHEMA.AJ_SALES;
CREATE OR REPLACE TABLE SOURCES CLONE DEMO_DATABASE.DEMO_SCHEMA.AJ_SOURCES;
CREATE OR REPLACE TABLE STATE_REGION CLONE DEMO_DATABASE.DEMO_SCHEMA.AJ_STATE_REGION;
CREATE OR REPLACE TABLE STATUSES CLONE DEMO_DATABASE.DEMO_SCHEMA.AJ_STATUSES;
CREATE OR REPLACE TABLE TYPE CLONE DEMO_DATABASE.DEMO_SCHEMA.AJ_TYPE;
